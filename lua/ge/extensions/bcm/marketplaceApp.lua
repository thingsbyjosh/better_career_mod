...
local function onAddedVehiclePartsToInventory(inventoryId, newParts)
  ...
  log('I', logTag, 'Fired onVehicleAddedToInventory hook for inv=' .. tostring(inventoryId) .. ' insuranceId=' .. tostring(info.insuranceId))
...
getSellPreconditions = function(inventoryId)
  ...
  -- NOTE: No sell restrictions for now (per Phase 50 discussion).
  -- Last-vehicle block and spawned-vehicle handling TBD after vanilla research.
  -- Loans do NOT block sales in BCM.
