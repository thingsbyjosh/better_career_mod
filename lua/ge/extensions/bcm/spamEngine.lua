...
local EVENT_SPAM_TEMPLATES = {
  loan_approved = {
    ...
    bodies = {
      "<p>Dear {name},</p><p>We noticed you recently took out a loan for your {vehicle}. <b>BIG MISTAKE.</b></p><p>Our rates start at <b>-2% APR</b>. Yes, that's negative. We PAY YOU to borrow money.</p><p>Switch to {sender} today!</p><p><span style='color:#999;font-size:9px;'>Rates not actually available. Or real.</span></p><p><a href='http://autoboss-system.fake/rates' style='color:#0066cc;text-decoration:underline;cursor:pointer;'>SEE OUR RATES</a></p>",
  ...
  vehicle_purchased = {
    ...
    bodies = {
      "<p>Dear {name},</p><p>Congratulations on your new {vehicle}! Now that you own one, you should know that {vehicle}s are the #1 target for alien abduction.</p><p>Our Alien Shield (only $499) will keep your {vehicle} safe from extraterrestrial threats.</p><p>— {sender}</p><p><a href='http://alien-shield.fake/protect' style='color:#0066cc;text-decoration:underline;cursor:pointer;'>GET ALIEN SHIELD</a></p>",
      "<p>Hey {name}!</p><p>Nice {vehicle}! You know what would make it even nicer? A <b>gold-plated air freshener</b>. Only $79.99 from {sender}.</p><p>Your {vehicle} deserves to smell like success.</p><p><a href='http://freecars4u.fake/accessories' style='color:#0066cc;text-decoration:underline;cursor:pointer;'>SHOP ACCESSORIES</a></p>",
    }
  },
  loan_payment = {
    subjects = {
    ...
    bodies = {
      "<p>Dear {name},</p><p>We know you just made a loan payment. Painful, isn't it? What if your {vehicle} could generate passive income while parked?</p><p>Our <b>ParkAndEarn</b> program turns your {vehicle} into a money machine. Sign up with {sender} today!</p><p><span style='color:#999;font-size:9px;'>Your vehicle will not actually earn money.</span></p><p><a href='http://parkandearn.fake/signup' style='color:#0066cc;text-decoration:underline;cursor:pointer;'>JOIN PARKANDEARN</a></p>",
    }
  },
  credit_score_change = {
    subjects = {
    ...
    bodies = {
      "<p><b style='color:red;'>CREDIT ALERT</b></p><p>Dear {name},</p><p>Your credit score just changed and we are <b>VERY concerned</b>. Actually, we don't know if it went up or down. But you should definitely be worried.</p><p>Purchase our CreditShield Premium ($29.99/month) to protect your score from... things.</p><p>— {sender}</p><p><a href='http://creditshield-premium.fake/subscribe' style='color:#0066cc;text-decoration:underline;cursor:pointer;'>GET CREDITSHIELD</a></p>",
    }
  },
}
