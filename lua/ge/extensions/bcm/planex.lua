...
local LOANER_TIERS = {
  [1] = { model = 'pigeon',    config = 'planex', capacity = 168,  name = 'Pigeon',    reputationLvl = -1, dailyCost = 35000,   cargoWarningPct = 20 },  -- $350/day
  [2] = { model = 'miramar',   config = 'planex', capacity = 128,  name = 'Miramar',   reputationLvl = -1, dailyCost = 75000,   cargoWarningPct = 60 },  -- $750/day
  [3] = { model = 'lansdale',  config = 'planex', capacity = 96,   name = 'Lansdale',  reputationLvl = 0,  dailyCost = 100000,  cargoWarningPct = 60 },  -- $1,000/day
  [4] = { model = 'van',       config = 'planex', capacity = 256,  name = 'H-Series',  reputationLvl = 1,  dailyCost = 430000,  cargoWarningPct = 60 },  -- $4,300/day
  [5] = { model = 'md_series', config = 'planex', capacity = 768,  name = 'MD Series', reputationLvl = 2,  dailyCost = 1770000, cargoWarningPct = 60 },  -- $17,700/day
  [6] = { model = 'us_semi',   config = 'planex', capacity = 1280, name = 'DT40L',     reputationLvl = 3,  dailyCost = 3400000, cargoWarningPct = 60 },  -- $34,000/day
}
...
acceptPack = function(packId)
  ...
  -- Resolve effective vehicle capacity from Vue (already slider-adjusted)
  -- Vue queries capacity fresh from Lua on each vehicle selection, applies slider, sends the result
  ...
  elseif usingLoaner then
    -- Fallback for loaner if Vue didn't send a valid capacity
    effectiveCapacity = usingLoaner.capacity
  end
...
completeStop = function(stopIndex)
  ...
  assessDamageAtStop(pack, stopIndex, function(payoutMult, damageLevel, brokenRelative)
    ...
    -- Phase 75.2: record per-stop scores for star rating
...
completePack = function()
  ...
  -- Phase 75.2: Star rating calculation (replaces speed penalty and per-stop damage multiplier)
...
M.onUpdate = function(dtReal, dtSim, dtRaw)
  ...
  -- Phase 75.2: G-force sampling — 0.5s interval (separate from 1s depot timer)
