...
local START_EPOCH = {year = 2026, month = 3, day = 15}  -- March 15, 2026
...
loadTimeData = function()
  ...
  if data then
    ...
    -- New career: initialize defaults
    ...
    log('I', logTag, 'No saved time data found. Initialized defaults (start: 17:00, March 15, 2026)')
  end
